...
{
    /// <summary>
    ///  An extension for string class to validate the phone number.
    /// </summary>
    public static class StringExtensions
    {
        ...
        public static bool ValidatePhoneNumber(this string phone, bool IsRequired)
        {
            ...
            else
            {
                ...
                else if (cleaned.Length > 0 & cleaned.Length < 10) return false;
                else if (cleaned.Length == 10) return true;
